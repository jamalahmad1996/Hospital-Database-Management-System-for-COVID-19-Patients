               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a class="active" href="doc.php">Doc</a></li>
                        <li><a class="active" href="nurse.php">Nurse</a></li>
                        <li><a class="active" href="diag.php">Diag</a></li>
                        <li><a class="active" href="test.php">Test</a></li>
                        <li><a class="active" href="lab.php">Lab</a></li>
                        <li><a class="active" href="reg.php">Reg</a></li>
                        <li><a class="active" href="supply.php">Supply</a></li>
                        <li><a class="active" href="appoint.php">Appoint</a></li>
