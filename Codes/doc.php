       ...
       <div id="log" class="section wow fadeIn">
         <div class="container">
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
               Doctor ID: <input type="text"  name="Doctor_IDtb"/> 
	       ...
	       Phone: <input type="text" name="Phonetb"/><br><br>
			...
			$Phone = $_POST['Phonetb'];
                     ...
                     $sql = "INSERT INTO doctor VALUES ('$Doctor_ID', '$LastName','$FirstName', '$Gender', '$Office','$Phone')";//embed insert statement in PHP
